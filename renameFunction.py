...
print(students.rename(columns={'marks':'percentage','package':'LPA'})) # not a permanent change
print(students)
print("-----------------------------------------------------------------------------------")
print(students.rename(columns={'marks':'percentage','package':'LPA'},inplace=True)) # for a permanent change
print(students)
